...
with tab1:
    ...
    with colA:
        if 'gpa' in df.columns:
            ...
            fig_gpa.update_xaxes(range=[None, 4.0], tickmode='linear', tick0=0, dtick=0.5)
...
with tab2:
    ...
    if 'study_hours_per_day' in df.columns and 'gpa' in df.columns:
        ...
        fig_scatter.update_yaxes(range=[None, 4.0], tickmode='linear', tick0=0, dtick=0.5)
    ...
    with col1:
        ...
        if 'study_hours_per_day' in df.columns and 'gpa' in df.columns:
            ...
            fig_binned.update_yaxes(range=[None, 4.0], tickmode='linear', tick0=0, dtick=0.5)
    ...
    with col2:
        ...
        if group_col in df.columns and 'gpa' in df.columns:
            ...
            fig_box.update_yaxes(range=[None, 4.0], tickmode='linear', tick0=0, dtick=0.5)
